            ...
            @if(auth()->user()->user_role == 1)
                <form action="{{ url('/update-user') }}" method="post" class="flex flex-wrap">
                    ...
                    <div class="mb-4 w-6/12 px-2">
                        ...
                        <select name="user_role" id="user_role" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('user_role') border-red-500 @enderror" value="{{ $user->user_role }}" required="required">
